...
I bought my first iPhone in 2010. Since then I haven't used devices from different manufacture because this one just works. No suppresises here — 32GB version of iPhone 7 Plus resides in my pocket. It is extremally stable, comfortable to use and it has one thing that makes me love this device — camera! Sometimes it is just hard to believe that something that small can give me quality like this. There's no rose without a thorn though. I'm getting jelous about access to realy cool features that users of latest Andoid smartphones have. [The (Not So) Secret Powers Of The Mobile Browser](https://www.smashingmagazine.com/2016/12/the-not-so-secret-powers-of-the-mobile-browser/) by [Stéphanie Walter](https://twitter.com/WalterStephanie/) is a great article on Smashing Magazine that walks us through cool modern features of mobile browsers. Cool, but the fact that I'm ultra excited about it doesn't mean that I can try any of them so... Apple, please! Catch up! We (developers) need Service Workers, we want to make progressive web apps, we wish to play around with payment or bluetooth interface as Googlers do. I won't use Android device from convenience reasons only but I may buy one of those fancy Pixels XL to mess around with VR and other cool stuff that Stéphanie wrote about.

### Bose QC35

This year another cool gadget joined a list of things that I'm not going out without in my bag. Bose QuietComfort 35 wireless headphones is probably the best spent £329 in my whole life. When I'm coding or writing the importance of isolation from outside world and being alone with my own thoughts is immensely important. I doubted sound quality of wireless, non-phisical soultions before I got them. Things changed aparently and I won't go back to cable - no chance. It has some occosional bluetoothe connectivity quirks and battery doesn't last forever but overall I'm extremally happpy and I can't imagine a single day of productive work without it. Lightweight contruction, quality build and sound quality is something that I expected from this price range product and I don't feel disapointed at all. Wanna test before placing an order? Grab a beer and pop in.

- - -

## Software

Followed similar principles I use much less software on my devices. Some little toys has been replaced with most holistic productivity solutions, some stayed as they were and lots of stuff just disapeared compared to the same list that I made [few years back](https://pawelgrzybek.com/my-web-development-setup/). Lets dig into my geeky toolset.

### Google Chrome

There must be a reson why this app stays the most popular web browser for years. No supprises here — Google Chrome is probably the most frequently used app on my computer. Despite the seamless bookmarks, plugins and setting syncronization, this browser has one big advantage compared to competitor — Google Dev Tools. Conveience of helpful panels for web developers is the main reason why I use it. Fantastic team of enginers who are working hard to make it better supprise me every release. React Developer Tools, Vue.js devtols, uBlock origin, Pinboard and 1Password extension is everything that I added to it.
