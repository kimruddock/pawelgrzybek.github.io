...
This year another cool gadget joined a list of things that I'm not going out without in my bag. Bose QuietComfort 35 wireless headphones is probably the best spent £329 in my whole life. When I'm coding or writing the importance of isolation from outside world and being alone with my own thoughts is immensely important. I doubted sound quality of wireless, non-phisical soultions before I got them. Things changed aparently and I won't go back to cable — no chance. It has some occosional bluetoothe connectivity quirks and battery doesn't last forever but overall I'm very happpy and I can't imagine a single day of productive work without it. Lightweight construction, quality build and sound quality is something that I expected from this price range of product and I don't feel disapointed at all. Wanna test before placing an order? Grab a beer and pop in my friend.

- - -

## Software

Following the same principle as with the hardware, I use much less software on my devices. Compared to [the same list](https://pawelgrzybek.com/my-web-development-setup/) that I made few years ago, some little toys has been replaced with more holistic productivity solutions, some stayed as they were and lots of stuff just disapeared. Lets dig into my geeky toolset.

### Google Chrome

There must be a reson why this app keeps it's status of the most popular web browser for many years. No supprises here — Google Chrome is probably the most frequently used app on my computer. Despite the seamless bookmarks, plugins and setting syncronization, this browser has one big advantage compared to it's competitors — Google Dev Tools. Plethora of helpful panels for web developers is the main reason why I use it. Fantastic team of enginers who are working hard to make it better supprise me every time when they release a new version. React Developer Tools, Vue.js devtols, uBlock origin, Pinboard and 1Password are the only extensions that I added to it.

### VSCode

As a huge fan of [Sublime Text](https://www.sublimetext.com/), creator of few plugins and active supporter of this app's developement, switching to a different code editor would be the least expected thing some time ago. In the meantime Microsoft did two tings that front-end developers should know about: [TypeScript](https://www.typescriptlang.org/) and [Visual Code Studio](https://code.visualstudio.com/). Typescript is fantastic, but do you know what is better? Yes, Visual Code Studio! Open-source, written entirely with web technologies like HTML, CSS and JavaScript wrapped into multiplatform desktop app with Electron, is lightweight, fast, beautiful and extremally powerful. Compared to ST where learning curve and configuration takes some time to fully embrace it's potential, VSCode gives you the top-notch user experience out of the box. Community loves to use it and improve it — just have a look at any of the monthly updates change log full of improvements and new features. Integrated command line saves me so much time on juming back and forth between editor and iTerm. Integrated Git client allows me to commit progress of my work, fetch changes from remote branch or push current state in fraction of a second. Built in IntelliSense makes my life a whole lot easier — methods definitions, parameters info, autocompletion. When an IDE ish look of it disturbs me I switch to minimal and desctraction free Zen mode with a single shortcut. I can really write a poem about it but it is no point, just download it, use it and love it as I do. If you are looking for helpful tips with smooth transition from Sublime Text to Microsoft's product, check few of my recent articles about [config files](https://pawelgrzybek.com/sync-vscode-settings-and-snippets-via-dotfiles-on-github/) and [custom tasks](https://pawelgrzybek.com/using-the-javascript-console-in-visual-studio-code/).

### Sketch & Affinity Photo

I'm not a designer and I use one of those apps once in a while. I just need a reliable tool to make a simple logo for my next open source project or crop image of my cat to upload it on Facebook. Sketch is probably the best UI design tools that I have ever experience with (yes I tried Adobe XD — cool but pricy). I love the intuitive workflow, speed, iCloud integration and of course plugins API that opens un wide area of oportunities. Affinity Photo is my Photoshop replacement — maybe it isn't that powerful, it doesn't have video editing options (why would you need that in PHOTOshop) and maybe there is not that much youtube tutorials as it is about Photoshop but it does the job really well. I published ["I won't miss you Adobe"](https://pawelgrzybek.com/i-wont-miss-you-adobe/) two years ago and nothing really changed since.
